...
public class Factura extends JFrame implements ActionListener {
	...
	String[] titulos = { "Codigo", "Producto", "Precio", "Cantidad", "Importe" };
	double subtotal = 0.0;
	double igv = 0.0;
	double total = 0.0;
	...
	public Factura() {
		...
		tblDatos.setSelectionBackground(new Color(30,129,176));
		tblDatos.setSelectionForeground(new Color(255,255,255));
